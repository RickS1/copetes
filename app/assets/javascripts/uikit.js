                    ...
                    // Youtube
                        ...
                        var id = matches[1],
                            setIframe = function (width, height) {
                                ...
                                return this$1.setItem(item, getIframe(("//www.youtube.com/embed/" + id), Math.floor((window.innerWidth*0.95 > 1390 ? 1390 : window.innerWidth * 0.95))/*width*/, Math.floor((window.innerWidth*0.95 > 1390 ? 782 : window.innerWidth * 0.534375))/*height*/, this$1.videoAutoplay));
                        };
